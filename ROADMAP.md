...
- five per-user destination anchors;
...
1. A repository cannot choose an absolute path or escape a destination anchor.
...
- workspace, absolute, elevated, or system-wide destinations;
