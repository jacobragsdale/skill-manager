...
This directory contains the standalone Agent Plugins download site. It serves a static landing page and reads release metadata from `releases/manifest.json`.
...
4. Update `website/releases/manifest.json` with paths relative to `website/releases/`, for example `releases/0.2.0/Agent-Plugins-Setup.exe`.
